...
The resulting regular expression matches any stringmatching either alternate expression. This is en extended regular expression, so the tag -E* should be used. If using basic regular expressions the | operator needs to be prefixed by \\. 
